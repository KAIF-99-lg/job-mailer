...
I wanted to apply for the Backend Developer role. I work with Node.js and Express, and I have built REST APIs, handled secure backend workflows, worked with MongoDB, and deployed applications on the cloud.

I recently built a full backend for a SaaS application — it includes reliable email queuing, file uploads, and a proper MVC structure. I have also built a fully functional E-Commerce Website with product listing, cart, and order management.
...
And a fully functional E-Commerce Website with product listing, cart, and order management.

For the backend side, I have built things like secure email automation, Nodemailer integration, file upload handling with Multer, and proper error handling. My code is on GitHub if you want to take a look:
https://github.com/KAIF-99-lg
...
I have also built a fully functional E-Commerce Website with product listing, cart, and order management.

I also built a complete SaaS backend with features like email automation, resume uploads, secure workflows, and dashboard analytics. You can explore my work on GitHub:
https://github.com/KAIF-99-lg
...
I have also built a fully functional E-Commerce Website with features like product listing, cart, and order management.
...
I am applying for the Node.js Developer position. I have been working with Node.js and Express to build backend systems — REST APIs, middleware, database integration with Mongoose, and email services using Nodemailer.

I recently built a production-ready backend for a SaaS app that handles bulk email sending, file uploads, secure workflow orchestration, and history tracking. I have also built the backend for a fully functional E-Commerce Website. The code is on GitHub:
https://github.com/KAIF-99-lg
...
class TemplateService {
   ...
   */
  async create(data) {
    const template = await Template.create({ ...data, isDefault: false });
    return template;
  }
